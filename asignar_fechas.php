            ...
            <div class="Container">
                ...
                <div class="formularios">
                    ...
                    <form action="controllers/modificar_fecha_ejecucion.php" method="post">
                            ...
                            ?>
                            <div>
                                <input class="form-control mb-3" <?php if($fechas_list["realizado"] == 1 ){ ?> readonly <?php }  ?> value="<?php echo $fechas_list["fecha"]?>" min="<?php echo $fecha_ini ?>" max="<?php echo $fecha_fin ?>" type="date" name="input_val_new<?php echo $contador_inputs ?>" required>
